...
MODEL_ID = 55
MODEL_NEW_DISPLAY_NAME = "集中调度平台_台风预测数据表"
MODEL_NEW_DESCRIPTION = (
    "台风预测数据表存储了台风预测的相关信息，包括预测ID、台风点ID、台风点时间生成、台风ID等，"
    "用于台风预测和预警，具有重要的气象业务价值。"
)
# ==========================
...
FIELD_MAP = {
    "id": ("自增ID", "自增ID，唯一标识每条记录"),
    "forecast_id": ("预测ID", "台风预测ID，由台风ID和预测站点名称组成"),
    "point_id": ("台风点ID", "台风点ID，由台风ID和台风点时间组成"),
    "forecast_tm": ("台风点时间生成", "台风点时间生成"),
    "typhoon_id": ("台风ID", "台风ID"),
    "create_time": ("入库时间", "记录入库时间"),
}
