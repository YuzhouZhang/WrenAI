...
export type DataSourceTableQueryVariables = Types.Exact<{
  name: Types.Scalars['String'];
}>;


export type DataSourceTableQuery = { __typename?: 'Query', dataSourceTable?: { __typename?: 'CompactTable', name: string, columns: Array<{ __typename?: 'CompactColumn', name: string, type: string }> } | null };
...
export const DataSourceTableDocument = gql`
...
/**
 * __useDataSourceTableQuery__
 *
 * To run a query within a React component, call `useDataSourceTableQuery` and pass it any options that fit your needs.
 * When your component renders, `useDataSourceTableQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDataSourceTableQuery({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useDataSourceTableQuery(baseOptions: Apollo.QueryHookOptions<DataSourceTableQuery, DataSourceTableQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DataSourceTableQuery, DataSourceTableQueryVariables>(DataSourceTableDocument, options);
      }
export function useDataSourceTableLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DataSourceTableQuery, DataSourceTableQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DataSourceTableQuery, DataSourceTableQueryVariables>(DataSourceTableDocument, options);
        }
export type DataSourceTableQueryHookResult = ReturnType<typeof useDataSourceTableQuery>;
export type DataSourceTableLazyQueryHookResult = ReturnType<typeof useDataSourceTableLazyQuery>;
export type DataSourceTableQueryResult = Apollo.QueryResult<DataSourceTableQuery, DataSourceTableQueryVariables>;
